...
-- Step 2: Set xlandinfra@gmail.com as the Super Admin
UPDATE users SET is_super_admin = TRUE WHERE email = 'xlandinfra@gmail.com';

-- Step 3: Verify the super admin was set
SELECT id, email, username, role, is_super_admin FROM users WHERE email = 'xlandinfra@gmail.com';
