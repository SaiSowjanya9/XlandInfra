  ...
  try {
    ...
    onboardedRows.forEach(row => {
      data.push({
        ...
        property_type: row.entry_type || row.property_type,
        ...
        block_names: row.block_names ? (typeof row.block_names === 'string' ? JSON.parse(row.block_names) : row.block_names) : null,
        ...
        units_per_block: row.units_per_block ? (typeof row.units_per_block === 'string' ? JSON.parse(row.units_per_block) : row.units_per_block) : null,
        ...
        block_unit_types: row.block_unit_types ? (typeof row.block_unit_types === 'string' ? JSON.parse(row.block_unit_types) : row.block_unit_types) : null,
        blockInfo: row.block_info,
        block_info: row.block_info,
        blockNA: !!row.block_na,
        block_na: !!row.block_na,
        numberOfBlocks: row.number_of_blocks,
        ...
        villa_plot_number: row.villa_plot_number,
        ...
        latitude: row.map_lat ? parseFloat(row.map_lat) : null,
        longitude: row.map_lng ? parseFloat(row.map_lng) : null,
        map_lat: row.map_lat,
        map_lng: row.map_lng,
        ...
        watchman_name: row.watchman_name || null,
        watchmanContact: row.watchman_contact || null,
        watchman_contact: row.watchman_contact || null,
        status: row.status,
    ...
    try {
      ...
      propRows.forEach(row => {
        ...
        data.push({
          ...
          total_units: row.total_units || row.number_of_units || 0,
          address: row.address,
