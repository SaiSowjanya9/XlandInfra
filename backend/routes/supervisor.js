...
router.get('/dashboard', requireSupervisorScope, async (req, res) => {
  try {
    ...
    const employeeId = await getEmployeeIdForZoneLookup(req, 'supervisor');
    ...
    console.log('[Supervisor Dashboard] supervisorId:', supervisorId, 'fpId:', franchisePartnerId, 'assignedZones:', assignedZones, 'unrestricted:', hasUnrestrictedAccess);
...
router.get('/schedules/all', requireSupervisorScope, async (req, res) => {
  try {
    ...
    try {
      ...
      console.log('[Supervisor All Schedules] Total count:', total);
    } catch (countErr) {
      console.log('[Supervisor All Schedules] Count query failed:', countErr.message);
    }
    ...
    try {
      ...
      schedules = result;
      console.log('[Supervisor All Schedules] Found schedules:', schedules.length);
    } catch (queryErr) {
