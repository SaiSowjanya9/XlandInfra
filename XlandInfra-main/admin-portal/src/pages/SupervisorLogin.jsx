    ...
    try {
      ...
      if (result.success) {
        ...
        if (userData.mustChangePassword) {
          ...
          safeSessionStorage.setItem('pm_auth_token', userData.token);
          safeSessionStorage.setItem('pm_current_user', JSON.stringify({
            ...userData.user,
            portal: 'supervisor'
          }));
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="relative bg-zinc-900/80 backdrop-blur-xl border border-zinc-700/50 rounded-2xl p-8 shadow-2xl">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-2xl text-amber-400">Supervisor Portal</h1>
            <p className="text-amber-400/70 text-sm mt-2">Sign in to manage field operations</p>
          </div>
