          ...
          <nav className="flex-1 px-3 py-4 space-y-1 overflow-y-auto">
            ...
            <div className="mt-3 pt-3" style={{ borderTop: `1px solid ${colors.divider}` }}>
              <button
                ...
                style={{
                  background: (isVendorActive || (expandedMenus.vendors && !isAnyMainNavActive)) ? colors.activeBg : 'transparent',
                  color: (isVendorActive || (expandedMenus.vendors && !isAnyMainNavActive)) ? colors.activeText : colors.primaryText,
                }}
            ...
            <div className="mt-1">
              <button
                ...
                className={`flex items-center ${sidebarCollapsed ? 'justify-center' : 'justify-between'} w-full px-4 py-2.5 rounded-xl transition-all duration-200 font-medium`}
                style={{
                  background: (isEstimatesActive || (expandedMenus.estimates && !isAnyMainNavActive)) ? colors.activeBg : 'transparent',
                  color: (isEstimatesActive || (expandedMenus.estimates && !isAnyMainNavActive)) ? colors.activeText : colors.primaryText,
                }}
