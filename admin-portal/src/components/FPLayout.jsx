...
const FPLayout = ({ admin, onLogout, children }) => {
  ...
  const allEmployeeSubItems = [
    ...
    { path: '/fp/employees/zones', icon: MapPin, label: 'Employee Zone', subLabel: 'Management' },
  ];
  ...
  const allEstimatesSubItems = [
    ...
    { path: '/fp/estimates/add-service', icon: PlusCircle, label: 'Add Service' },
  ...
  const schedulesSubItems = [
    ...
    { path: '/fp/schedules/all', icon: List, label: 'All Schedules' },
    { path: '/fp/schedules/calendar', icon: CalendarDays, label: 'Calendar' },
    { path: '/fp/schedules/reschedule-requests', icon: RefreshCcw, label: 'Rescheduled Requests' },
