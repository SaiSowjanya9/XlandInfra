    ...
    <div className="space-y-6">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-4">
            <div className="text-right">
              <p className="text-sm text-teal-200">Pending Work Orders</p>
              <p className="text-3xl font-bold">{stats?.pendingWorkOrders || 0}</p>
            </div>
            <div className="w-px h-12 bg-white/20" />
            <div className="text-right">
              <p className="text-sm text-teal-200">Completed Today</p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-white rounded-xl border border-gray-100 p-5">
          ...
          <button
            onClick={() => navigate('/coordinator/work-orders/pending')}
        ...
        <div className="bg-white rounded-xl border border-gray-100 p-5">
          ...
          <button
            onClick={() => navigate('/coordinator/work-orders/completed')}
        ...
        <div className="bg-white rounded-xl border border-gray-100 p-5">
          ...
          <button
            onClick={() => navigate('/coordinator/estimates')}
