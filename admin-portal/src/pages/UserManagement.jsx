...
const UserManagement = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (editingUser) {
      ...
      // For new users, password is auto-generated
      const result = addUser(formData);
      if (result.success) {
        showToast(`User created successfully! User ID: ${result.user.userId}. Welcome email with login credentials has been sent.`);
        loadUsers();
        setShowModal(false);
        resetForm();
      } else {
