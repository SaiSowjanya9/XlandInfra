        ...
        {loading ? (
          ...
          <div className="overflow-x-auto">
            ...
            <div className="px-4 py-3 border-t border-gray-100 text-sm text-gray-500">
              Showing {filteredVendors.length} of {statusFilteredVendors.length} vendors
            </div>
          </div>
        )}
      </div>
      ...
      {editVendor && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4" onClick={() => setEditVendor(null)}>
          <div className="bg-white rounded-xl max-w-3xl w-full max-h-[90vh] flex flex-col" onClick={e => e.stopPropagation()}>
            {/* Fixed Header */}
            <div className="p-6 bg-gray-50 rounded-t-xl flex items-center justify-between flex-shrink-0 border-b border-gray-200">
              <div>
            ...
            <div className="p-4 border-t border-gray-200 bg-gray-50 flex justify-end gap-3 flex-shrink-0 rounded-b-xl">
              <button type="button" onClick={() => setEditVendor(null)} className="px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors">
                Cancel
              </button>
              <button type="submit" form="editVendorForm" className="flex items-center gap-2 px-5 py-2 text-sm font-medium text-white bg-amber-600 rounded-lg hover:bg-amber-700 transition-colors">
