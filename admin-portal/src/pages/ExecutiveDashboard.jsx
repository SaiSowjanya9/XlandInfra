  ...
  const fetchDashboard = useCallback(async (isInitialLoad = false) => {
    ...
    try {
      ...
      const [dashRes, estRes, propRes, woRes, vendorRes] = await Promise.all([
        fetch(`${API_BASE}/api/executive/dashboard`, { headers: { 'Authorization': `Bearer ${token}` } }),
        fetch(`${API_BASE}/api/executive/estimates`, { headers: { 'Authorization': `Bearer ${token}` } }),
        fetch(`${API_BASE}/api/executive/properties`, { headers: { 'Authorization': `Bearer ${token}` } }),
        fetch(`${API_BASE}/api/executive/work-orders`, { headers: { 'Authorization': `Bearer ${token}` } }).catch(() => ({ ok: false })),
        fetch(`${API_BASE}/api/executive/vendors`, { headers: { 'Authorization': `Bearer ${token}` } }).catch(() => ({ ok: false }))
      ]);
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between gap-4 flex-nowrap overflow-x-auto">
        <div className="flex items-center gap-6 flex-nowrap">
          <div className="shrink-0 min-w-max">
            ...
            <p className="text-gray-500 mt-1 whitespace-nowrap">Here's what's happening with your assigned areas today.</p>
          </div>
          <div className="flex items-center gap-3 flex-nowrap">
            <button onClick={() => navigate('/executive/properties')} className="bg-white rounded-xl border border-gray-100 px-4 py-3 hover:shadow-lg hover:border-blue-200 transition-all duration-200 group text-left">
            ...
            <button onClick={() => navigate('/executive/vendors')} className="bg-white rounded-xl border border-gray-100 px-4 py-3 hover:shadow-lg hover:border-purple-200 transition-all duration-200 group text-left">
              <div className="flex items-center gap-3">
            ...
            <button onClick={() => navigate('/executive/employees/zones')} className="bg-white rounded-xl border border-gray-100 px-4 py-3 hover:shadow-lg hover:border-orange-200 transition-all duration-200 group text-left">
              <div className="flex items-center gap-3">
            ...
            <button onClick={() => navigate('/executive/work-orders')} className="bg-white rounded-xl border border-gray-100 px-4 py-3 hover:shadow-lg hover:border-indigo-200 transition-all duration-200 group text-left">
              <div className="flex items-center gap-3">
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-6">
        <div className="flex items-center justify-between mb-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <button onClick={() => navigate('/executive/properties')} className="text-sm text-blue-600 hover:text-blue-700 font-medium flex items-center gap-1">
      ...
      <div className="bg-white rounded-xl border border-gray-100 p-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          <button
            onClick={() => navigate('/executive/customers/add')}
          ...
          <button
            onClick={() => navigate('/executive/employees')}
            className="flex items-center justify-between p-4 bg-gray-50 rounded-xl hover:bg-gray-100 transition-colors group"
          >
            <div className="flex items-center gap-3">
