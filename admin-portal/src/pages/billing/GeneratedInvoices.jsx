            ...
            <div className="overflow-y-auto flex-1 px-5 py-4 bg-white space-y-4">
              ...
              {selectedInvoice.invoiceType !== 'work_order' && (() => {
                ...
                const services = allItems.map(item => {
                  ...
                  const serviceName = decodeHtmlEntities(
                  ...
                  let serviceDesc = decodeHtmlEntities(
                    item.details || 
                  ...
                  if (!serviceDesc && item.description) {
                    const fullDesc = decodeHtmlEntities(String(item.description));
              ...
              {selectedInvoice.invoiceType !== 'work_order' && (() => {
                ...
                const addonItems = rawItems.filter(item => {
                        ...
                        <tbody className="divide-y divide-gray-100">
                          {addons.map((item, idx) => (
                            <tr key={idx} className="bg-white">
                              ...
                              <td className="px-2 py-2 text-xs text-gray-600 text-center">{item.frequency}</td>
                              <td className="px-2 py-2 text-xs font-medium text-gray-800 text-center">{item.visits}</td>
                              <td className="px-2 py-2 text-xs font-medium text-gray-800 text-right">{formatCurrency(item.price)}</td>
                            </tr>
                          ))}
                        </tbody>
                      </table>
