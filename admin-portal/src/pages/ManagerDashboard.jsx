      ...
      <div className="flex items-center justify-between gap-4 flex-nowrap overflow-visible">
        <div className="flex items-center gap-6 flex-nowrap">
          <div className="shrink-0 min-w-max">
            ...
            <p className="text-gray-500 mt-1 whitespace-nowrap">Here's what's happening with your managed areas today.</p>
          </div>
          <div className="flex items-center gap-2 flex-nowrap">
            <Link to="/manager/properties" className="bg-white rounded-lg border border-gray-100 px-3 py-2 hover:shadow-md hover:border-blue-200 transition-all duration-200 group">
            ...
            <Link to="/manager/vendors" className="bg-white rounded-lg border border-gray-100 px-3 py-2 hover:shadow-md hover:border-amber-200 transition-all duration-200 group">
              <div className="flex items-center gap-2">
            ...
            <Link to="/manager/employees/zones" className="bg-white rounded-lg border border-gray-100 px-3 py-2 hover:shadow-md hover:border-orange-200 transition-all duration-200 group">
              <div className="flex items-center gap-2">
